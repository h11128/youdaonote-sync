...
| 文档 | 与本分析的关系 |
|------|-------------|
| [rust-rewrite-analysis.md](../archive/design/rust-rewrite-analysis.md) | Rust 重写不可行的详细论证（AI 写 Rust 效率低、58% bug 是逻辑问题）。TypeScript 避免了 Rust 的问题 |
...
| [git-lessons-and-algorithms.md](../archive/design/git-lessons-and-algorithms.md) | content hash + Merkle tree 已实现但只用于辅助。新架构将 content hash 作为核心决策驱动 |
