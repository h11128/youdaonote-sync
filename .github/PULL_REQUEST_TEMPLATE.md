...
Use [README diagnose](../README.md#note-表格诊断) when applicable. For NOTE table render issues, see [incident retrospective](../docs/postmortem/2026-03-24-note-table-incident.md).
