...
if TYPE_CHECKING:
    import httpx
    from src.common import FileId, DirId
...
class FileReader(Protocol):
    ...
    def get_file_by_id(self, file_id: FileId) -> httpx.Response: ...
...
class HttpClient(Protocol):
    ...
    def http_post(self, url: str, data: Any = ...) -> httpx.Response: ...
...
class SyncApi(Protocol):
    ...
    def get_file_by_id(self, file_id: FileId) -> httpx.Response: ...
    def delete_file(self, file_id: FileId) -> dict: ...
    def move_file(self, file_id: FileId, new_parent_id: DirId, domain: int = 1) -> dict: ...
