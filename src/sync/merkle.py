...
from src.common import ContentHash, TreeHash

if TYPE_CHECKING:
    from src.sync.utils import LocalFileInfo


def build_tree(local_files: Dict[str, "LocalFileInfo"], hash_cache: Dict[str, ContentHash]) -> Dict[str, TreeHash]:
    ...
    for d in sorted_dirs:
        ...
        result[d] = TreeHash(xxhash.xxh3_128(data).hexdigest())

    return result


def diff_trees(old_hashes: Dict[str, TreeHash], new_hashes: Dict[str, TreeHash]) -> Set[str]:
